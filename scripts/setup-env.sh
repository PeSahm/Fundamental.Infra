...
echo "🔧 Setting up Terraform/Terragrunt environment..."
echo ""
...
echo "   3. Zone Resources: Include → Specific zone → academind.ir"
echo ""
...
if [ -z "$CLOUDFLARE_ZONE_ID" ]; then
    echo ""
    echo "   To get Zone ID: Cloudflare Dashboard → academind.ir → Overview (right sidebar)"
...
echo "✅ Variables exported to current session"
